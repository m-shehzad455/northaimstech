...
const Graph = () => {
  return (
    <div className="w-full py-2 mt-4 xl:w-full">
      <div className="flex justify-between">
        ...
        <div className="grid grid-cols-4 gap-4">
          {date.map((item, index:number) => (
            <div key={index} className="bg-[#EFF2F7] py-1 px-2 rounded font-normal font-400 text-[11px]">
              {item}
            </div>
          ))}
        </div>
      </div>
      <div className="grid grid-cols-1 h-80 xl-96 lg:h-72 -z-50">
